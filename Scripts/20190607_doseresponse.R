...
load("~/Dropbox/AndersenLab/LabFolders/Clay/2019_benzimidazole_paper/Processed_data/20190607subtract_constrain.Rdata")
...
subtract_dr_to_pc%>%
  ...
  dplyr::mutate(con_fix = factor(condition, levels = c("DMSO", "abz3125","abz625","abz125","abz25","abz50")))%>%
  ggplot()+
  ...
  #geom_jitter()+
  ylab("median EXT")+
  scale_x_discrete(labels=c("DMSO" = "DMSO", "abz3125" = "3.125uM","abz625" = "6.25uM","abz125"="12.5uM","abz25"="25uM","abz50"="50uM"))+
...
ggsave("~/Dropbox/AndersenLab/LabFolders/Clay/2019_benzimidazole_paper/plots/20190607_ABZv3/subtract_dose_medianEXT.png", device = "png", plot = last_plot(), width = 14, height = 6, units = "in")
...
subtract_dr_to_pc%>%
  ...
  theme(axis.title.x=element_blank(),
        ...
        legend.text = element_text(size=28,face = "bold"),
        legend.position = "None")
ggsave("~/Dropbox/AndersenLab/LabFolders/Clay/2019_benzimidazole_paper/plots/20190607_ABZv3/subtract_dose_medianTOF.png", device = "png", plot = last_plot(), width = 14, height = 6, units = "in")
...
subtract_dr_to_pc%>%
  ...
  theme(axis.title.x=element_blank(),
        ...
        legend.text = element_text(size=28,face = "bold"),
        legend.position = "None")
ggsave("~/Dropbox/AndersenLab/LabFolders/Clay/2019_benzimidazole_paper/plots/20190607_ABZv3/subtract_dose_q90tof.png", device = "png", plot = last_plot(), width = 14, height = 6, units = "in")
...
subtract_dr_to_pc%>%
  ...
  theme(axis.title.x=element_blank(),
        ...
        legend.text = element_text(size=28,face = "bold"),
        legend.position = "None")
ggsave("~/Dropbox/AndersenLab/LabFolders/Clay/2019_benzimidazole_paper/plots/20190607_ABZv3/subtract_dose_q90ext.png", device = "png", plot = last_plot(), width = 14, height = 6, units = "in")
