...
dir <- c("~/Dropbox/AndersenLab/LabFolders/Clay/2019_benzimidazole_paper/Raw_data/20190617_ABZv3dose/")
...
###REMOVED NO STRAIN SPECIFIC CLUSTERING USED
#mylist <- NULL
...
save(out_pruned, file = "~/Dropbox/AndersenLab/LabFolders/Clay/2019_benzimidazole_paper/Processed_data/20190617pruned_constrain.Rdata")
...
save(subtract_dr_to_pc, file = "~/Dropbox/AndersenLab/LabFolders/Clay/2019_benzimidazole_paper/Processed_data/20190617subtract_constrain.Rdata")
save(x, file = "~/Dropbox/AndersenLab/LabFolders/Clay/2019_benzimidazole_paper/Processed_data/20190617subtract_pruned.Rdata")
