...
###Read in FBZ V3 dose from 20190606
setwd("~/Dropbox/AndersenLab/LabFolders/Clay/2019_benzimidazole_paper/Processed_data/")
dir <- c("~/Dropbox/AndersenLab/LabFolders/Clay/2019_benzimidazole_paper/Raw_data/20190606_FBZ_v3/")
...
summedplate <- easysorter::sumplate(raw_noncontam,v3_assay = TRUE, directories = FALSE, quantiles = TRUE)
...
save(out_pruned, file = "~/Dropbox/AndersenLab/LabFolders/Clay/2019_benzimidazole_paper/Processed_data/20190606pruned_constrain.Rdata")

p <- c("N2", "882","920","1082","1075")
...
save(para_regressed, file = "~/Dropbox/AndersenLab/LabFolders/Clay/2019_benzimidazole_paper/Processed_data/20190606para_regressed.Rdata")


full <- regress(out_pruned)

save(full, file = "~/Dropbox/AndersenLab/LabFolders/Clay/2019_benzimidazole_paper/Processed_data/20190606_regressed.Rdata")
...
save(subtract_dr_to_pc, file = "~/Dropbox/AndersenLab/LabFolders/Clay/2019_benzimidazole_paper/Processed_data/20190606subtract_constrain.Rdata")
