...
subtract_dr_to_pc%>%
  ...
  theme(axis.title.x=element_blank(),
        ...
        legend.text = element_text(size=28,face = "bold"),
        legend.position = "None")
ggsave("~/Dropbox/AndersenLab/LabFolders/Clay/2019_benzimidazole_paper/plots/20190617_ABZdose/subtract_dose_medianEXT.png", device = "png", plot = last_plot(), width = 14, height = 6, units = "in")
...
subtract_dr_to_pc%>%
  ...
  theme(axis.title.x=element_blank(),
        ...
        legend.text = element_text(size=28,face = "bold"),
        legend.position = "None")
ggsave("~/Dropbox/AndersenLab/LabFolders/Clay/2019_benzimidazole_paper/plots/20190617_ABZdose/subtract_dose_medianTOF.png", device = "png", plot = last_plot(), width = 14, height = 6, units = "in")
...
subtract_dr_to_pc%>%
  ...
  theme(axis.title.x=element_blank(),
        ...
        legend.text = element_text(size=28,face = "bold"),
        legend.position = "None")
ggsave("~/Dropbox/AndersenLab/LabFolders/Clay/2019_benzimidazole_paper/plots/20190617_ABZdose/subtract_dose_q90tof.png", device = "png", plot = last_plot(), width = 14, height = 6, units = "in")
...
subtract_dr_to_pc%>%
  ...
  theme(axis.title.x=element_blank(),
        ...
        legend.text = element_text(size=28,face = "bold"),
        legend.position = "None")
ggsave("~/Dropbox/AndersenLab/LabFolders/Clay/2019_benzimidazole_paper/plots/20190617_ABZdose/subtract_dose_q90ext.png", device = "png", plot = last_plot(), width = 14, height = 6, units = "in")
...
subtract_dr_to_pc%>%
  ...
  theme(axis.title.x=element_blank(),
        ...
        legend.text = element_text(size=28,face = "bold"),
        legend.position = "None")
ggsave("~/Dropbox/AndersenLab/LabFolders/Clay/2019_benzimidazole_paper/plots/20190617_ABZdose/subtract_dose_meantof.png", device = "png", plot = last_plot(), width = 14, height = 6, units = "in")
...
subtract_dr_to_pc%>%
  ...
  theme(axis.title.x=element_blank(),
        ...
        legend.text = element_text(size=28,face = "bold"),
        legend.position = "None")
ggsave("~/Dropbox/AndersenLab/LabFolders/Clay/2019_benzimidazole_paper/plots/20190617_ABZdose/subtract_dose_meanext.png", device = "png", plot = last_plot(), width = 14, height = 6, units = "in")
